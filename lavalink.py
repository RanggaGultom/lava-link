...
class lavalinkserver:
    ...
    def __init__(self):
        self.download_command = "curl -s https://github.com/darkforest-beep/lavalinkz/releases/download/3.3.2/Lavalink.jar| grep browser_download_url | cut -d '\"' -f 4 | wget -qi -"
