...
class lavalinkserver:
    ...
    def __init__(self):
        self.download_command = "curl -s https://ci.fredboat.com/repository/download/Lavalink_Build/8107:id/Lavalink.jar| grep browser_download_url | cut -d '\"' -f 4 | wget -qi -"
